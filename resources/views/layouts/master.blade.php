...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <span class="brand-text font-weight-light ml-3">Admin Posyandu</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('adminLTE/')}}/img/avatar_icon3.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="/permeriksaan" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="data_anak" class="nav-link">
          ...
          <li class="lnr lnr-exit has-treeview">
  ...
  <footer class="main-footer">
    <center><strong>Copyright &copy; 2019-2020 Tugas Akhir Arief Lukman</a>.</strong>
